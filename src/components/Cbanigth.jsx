...
const cordobaClubs = [
  {
    ...
    photos: [
      ...
      "/fotos/boliches/cba/molinorojo5.jpg",
      {
        type: "iframe",
        provider: "facebook",
        src: "https://www.facebook.com/plugins/video.php?href=https%3A%2F%2Fwww.facebook.com%2Freel%2F1141643904577436%2F&width=267&show_text=false",
        width: 267,
        height: 476,
        allow:
            ...
            <div
              ...
              style={{
                transform: `translateX(-${
                  featuredIndex * (100 / Math.min(featuredClubs.length || 1, 3))
                }%)`,
                width: `${
                  featuredClubs.length *
                  (100 / Math.min(featuredClubs.length || 1, 3))
                }%`,
              }}
            >
              {featuredClubs.map((club) => (
                ...
                >
                  ...
                  >
                    <Img
                      src={
                        club.photos[0] && typeof club.photos[0] === "string"
                          ? club.photos[0]
                          : club.logo
                      }
                      alt={club.name}
                  ...
                  if (item && item.type === "iframe") {
                    return (
                      <div className="w-full flex justify-center">
                        <div
                          className="relative w-full max-w-[267px]" // ancho del iframe original
                          style={{ aspectRatio: "267 / 476" }} // conserva la proporción del iframe
                        >
                          <iframe
                            src={item.src}
                            width={item.width || 267}
                            height={item.height || 476}
                            style={{
                              border: "none",
                              width: "100%",
                              height: "100%",
              ...
              <div>
                ...
                <div className="text-xs text-gray-400">
                  {(() => {
                    ...
                    if (item && item.type === "iframe")
                      return `${item.provider || "Video embed"} (abrir)`;
                    return "";
                  })()}
                </div>
              </div>
